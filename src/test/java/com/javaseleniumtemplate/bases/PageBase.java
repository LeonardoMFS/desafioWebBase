...
public class PageBase {
    ...
    protected void comboBoxSelectByIndex(By locator, String index){
        Select comboBox = new Select(waitForElement(locator));
    ...
    public void selecionarItemDropDown(String projectName, String drop) {
        Actions action = new Actions(driver);
    ...
    public static void definirElementoAtributo(WebDriver driver, WebElement elemento, String atributo, String valor) {
        JavascriptExecutor jsExecutor = (JavascriptExecutor) driver;
        jsExecutor.executeScript("arguments[0].setAttribute(arguments[1], arguments[2]);", elemento, atributo, valor);
    }
    ...
    public void dropBox(By upload) {
        ...
        definirElementoAtributo(driver, inputUpload, style, "");
    }
}
